/* eslint-disable */
/* THIS FILE WAS AUTO-GENERATED USING CATALOG EXPORTER; YOU SHOULD NOT EDIT THIS FILE; GENERATE TIME: 2022-09-08T03:20:01.634Z; */
 ...
 * Metric Type: MAQL Metric
 */
export const Metric1: IMeasure<IMeasureDefinition> = newMeasure(idRef("metric_1", "measure"));
/**
 * Metric Title: _Close [EOP] (2)
 * Metric ID: close_eop_2
 * Metric Type: MAQL Metric
 */
export const CloseEOP2: IMeasure<IMeasureDefinition> = newMeasure(idRef("close_eop_2", "measure"));
/**
 * Metric Title: amount_bop
 * Metric ID: amount_bop_edit
 * Metric Type: MAQL Metric
 */
export const AmountBop: IMeasure<IMeasureDefinition> = newMeasure(idRef("amount_bop_edit", "measure"));
/**
 * Metric Title: abcd
 * Metric ID: abcd
 * Metric Type: MAQL Metric
 */
export const Abcd: IMeasure<IMeasureDefinition> = newMeasure(idRef("abcd", "measure"));
/**
 * Metric Title: test1
 * Metric ID: test1
 * Metric Type: MAQL Metric
 */
export const Test1: IMeasure<IMeasureDefinition> = newMeasure(idRef("test1", "measure"));
/**
 * Metric Title: test
 * Metric ID: test
 * Metric Type: MAQL Metric
...
export const Insights = {
  ...
  /**
   * Insight Title: TOTAL
   * Insight ID: 46067542-83ea-4756-a6b8-eed81c5bee4a
   */,
  TOTAL: "46067542-83ea-4756-a6b8-eed81c5bee4a"
  /**
   * Insight Title: local
   * Insight ID: 15d22dfc-e825-4f24-9ecc-ad8bd20dde02
   */,
  Local: "15d22dfc-e825-4f24-9ecc-ad8bd20dde02"
  /**
   * Insight Title: [do not update] global and local attribute filters
   * Insight ID: e48ed313-df20-4d18-bb32-1194cde48fc3
   */,
  DoNotUpdateGlobalAndLocalAttributeFilters: "e48ed313-df20-4d18-bb32-1194cde48fc3"
  /**
   * Insight Title: [do not update] attribute filter and other filters
   * Insight ID: 14fe10f0-5a72-43fb-849d-05584e42ae5d
   */,
  DoNotUpdateAttributeFilterAndOtherFilters: "14fe10f0-5a72-43fb-849d-05584e42ae5d"
  /**
   * Insight Title: OPP
   * Insight ID: e951a2d0-d3bd-4c70-acdb-1d02b6c5565c
   */,
  OPP: "e951a2d0-d3bd-4c70-acdb-1d02b6c5565c"
  /**
   * Insight Title: 21/7
   * Insight ID: d66b01af-73f5-4212-8f7e-cc6516c21a8e
   */,
  _217: "d66b01af-73f5-4212-8f7e-cc6516c21a8e"
  /**
   * Insight Title: 21/7 - copy
   * Insight ID: c34ce9fa-9605-4e58-864c-16528eb308d8
   */,
  _217Copy: "c34ce9fa-9605-4e58-864c-16528eb308d8"
  /**
   * Insight Title: CSP1
   * Insight ID: a701a323-7805-4384-b64c-4d74cff3973e
   */,
  CSP1: "a701a323-7805-4384-b64c-4d74cff3973e"
  /**
   * Insight Title: CSP2
   * Insight ID: 472810e0-6515-4d6d-8051-02517f6e11d6
   */,
  CSP2: "472810e0-6515-4d6d-8051-02517f6e11d6"
  /**
   * Insight Title: aâhhaa
   * Insight ID: 22d8b01a-b2e4-46df-a138-ca5968f5c660
   */,
  Aahhaa: "22d8b01a-b2e4-46df-a138-ca5968f5c660"
  /**
   * Insight Title: sumof
   * Insight ID: acdce9cc-6232-4d4f-978c-ad573d2c5edf
   */,
  Sumof: "acdce9cc-6232-4d4f-978c-ad573d2c5edf",
};
export const Dashboards = {
  /**
   * Dashboard Title: KD
   * Dashboard ID: d2e9e7b6-ba2d-4c74-81be-ab2b1482a45f
   */
  KD: "d2e9e7b6-ba2d-4c74-81be-ab2b1482a45f"
  /**
   * Dashboard Title: [do not update] attribute filter check
   * Dashboard ID: 17bc51e0-a40e-44fb-b5fa-2600d79d5efa
   */,
  DoNotUpdateAttributeFilterCheck: "17bc51e0-a40e-44fb-b5fa-2600d79d5efa"
  /**
   * Dashboard Title: [do not update] target drill
   * Dashboard ID: 891f1947-9008-4ada-b3be-5d3aee280fe1
   */,
  DoNotUpdateTargetDrill: "891f1947-9008-4ada-b3be-5d3aee280fe1"
  /**
   * Dashboard Title: Untitled
   * Dashboard ID: efd5f8ee-0373-448b-b0d1-2760a1a3a7e3
   */,
  Untitled: "efd5f8ee-0373-448b-b0d1-2760a1a3a7e3"
  /**
   * Dashboard Title: CSP test
   * Dashboard ID: 518e1c27-6687-45d4-a29c-c033840be269
   */,
  CSPTest: "518e1c27-6687-45d4-a29c-c033840be269"
  /**
   * Dashboard Title: new
   * Dashboard ID: 2a0a80db-87db-4f7e-adc5-cbba28276898
   */,
  New: "2a0a80db-87db-4f7e-adc5-cbba28276898",
};
